...
const content = [
  {
    ...
    icon: faInfoCircle,
    content:
      'At EzTech PrinterSolutions, we are your trusted specialists in resolving printer issues across all brands and models. With a strong focus on restoring your printers to full functionality, we ensure that your devices are up and running smoothly, minimizing downtime and frustration. Additionally, we offer a wide range of tech services designed to meet your every need.',
  },
  {
    id: 3,
    title: 'Our Mission',
    ...
    <div className="bg-gradient-to-r from-blue-100 to-blue-200 py-10">
      <div className="container mx-auto px-4 mt-20 bg-white shadow-lg p-8 rounded-lg">
        <h1 className="text-[#0C71C3] text-4xl font-extrabold text-center mb-10">
          Welcome to <span className="text-blue-600">EzTech Printer</span><span className="text-blue-800">Solutions</span>
        </h1>
